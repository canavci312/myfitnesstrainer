...
class CheckWorkoutHistoryPage extends StatelessWidget {
  @override
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Column(
                    ...
                    children: [
                      index !=
                              _allWorkoutLogs
                                      .allWorkoutLogs.workoutLogs.length -
                                  1
                          ? isDifferentMonth(
                                  _allWorkoutLogs
                                      .allWorkoutLogs.workoutLogs[index].date,
                                  _allWorkoutLogs.allWorkoutLogs
